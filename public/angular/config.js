...
angular
    ...
    .directive('smoothScroll', ['$log', '$timeout', '$window', function ($log, $timeout, $window) {
...
angular.module('escomm', ['ngResource', 'ngSanitize', 'ngAnimate', 'ngRoute', 'escomm.WebService', 'gettext', 'angularSmoothscroll']);
